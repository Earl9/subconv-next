...
func shouldRequireRealNodeInPolicyGroup(groupName string, opts model.RenderOptions) bool {
	...
	case "", "🛑 广告拦截", "🏠 私有网络", "🔒 国内服务", "🚀 节点选择", "⚡ 自动选择":
		return false
	case "🤖 AI 服务", "📹 油管视频", "📚 教育学术", "☁️ 云服务", "🔍 谷歌服务", "📲 电报消息", "🐱 代码托管", "☁️ 微软云盘", "Ⓜ️ 微软服务", "🍏 苹果服务", "🐦 推特/X", "📘 Meta 系", "🎙️ Discord", "💬 其他社交", "🎬 奈飞", "🏰 迪士尼+", "📺 欧美流媒体", "🎌 亚洲流媒体", "🎮 Steam", "🖥️ PC 游戏", "🎯 主机游戏", "🛠️ 开发工具", "💾 网盘存储", "💳 支付平台", "₿ 加密货币", "📰 新闻资讯", "🛒 海淘购物", "🌍 非中国", "🐟 漏网之鱼":
		return true
	default:
		return false
	}
