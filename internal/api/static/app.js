    ...
    options: [
      {
        key: "none",
        label: "跟随当前服务模板",
        description: "模板模式下跟随后端 service.template 的 lite / standard / full 预设。",
        ruleProfile: "跟随服务模板",
        groupProfile: "自动继承",
      },
      {
    ...
    options: [
      {
        key: "cm_online",
        label: "CM_Online 默认版",
        description: "偏向常用国际访问场景，覆盖 Google、Telegram、微软、苹果等常见业务。",
        ruleProfile: "通用国际分流",
        groupProfile: "紧凑代理组",
      },
      {
    ...
    options: [
      {
        key: "custom_url",
        label: "自定义外部模板 URL",
        description: "仅保留兼容字段。当前仍使用内置 renderer 生成，不直接替换本地模板。",
        ruleProfile: "兼容保留",
        groupProfile: "回退内置模板",
      },
    ],
...
const OUTPUT_OPTIONS = [
  { key: "emoji", id: "opt-emoji", title: "启用 Emoji", desc: "为节点名称添加 Emoji 图标", default: true, icon: "spark" },
...
const ICONS = {
  settings: svgIcon('<circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09a1.65 1.65 0 0 0-1-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 8.92 4.6H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09A1.65 1.65 0 0 0 15 4.6a1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9c.36.58.56 1.25.6 1.93.04.68-.12 1.37-.6 2.07Z"></path>'),
  sliders: svgIcon('<line x1="4" y1="21" x2="4" y2="14"></line><line x1="4" y1="10" x2="4" y2="3"></line><line x1="12" y1="21" x2="12" y2="12"></line><line x1="12" y1="8" x2="12" y2="3"></line><line x1="20" y1="21" x2="20" y2="16"></line><line x1="20" y1="12" x2="20" y2="3"></line><line x1="2" y1="14" x2="6" y2="14"></line><line x1="10" y1="8" x2="14" y2="8"></line><line x1="18" y1="16" x2="22" y2="16"></line>'),
  link: svgIcon('<path d="M10 13a5 5 0 0 0 7.07 0l2.12-2.12a5 5 0 1 0-7.07-7.07L11 5"></path><path d="M14 11a5 5 0 0 0-7.07 0L4.81 13.12a5 5 0 1 0 7.07 7.07L13 19"></path>'),
  target: svgIcon('<circle cx="12" cy="12" r="8"></circle><circle cx="12" cy="12" r="3"></circle><line x1="12" y1="2" x2="12" y2="5"></line><line x1="12" y1="19" x2="12" y2="22"></line><line x1="2" y1="12" x2="5" y2="12"></line><line x1="19" y1="12" x2="22" y2="12"></line>'),
  server: svgIcon('<rect x="3" y="4" width="18" height="7" rx="2"></rect><rect x="3" y="13" width="18" height="7" rx="2"></rect><line x1="7" y1="8" x2="7.01" y2="8"></line><line x1="7" y1="17" x2="7.01" y2="17"></line><line x1="11" y1="8" x2="17" y2="8"></line><line x1="11" y1="17" x2="17" y2="17"></line>'),
  file: svgIcon('<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline>'),
  filter: svgIcon('<polygon points="3 4 21 4 14 12 14 19 10 21 10 12 3 4"></polygon>'),
  shield: svgIcon('<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10Z"></path>'),
  zap: svgIcon('<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon>'),
  list: svgIcon('<line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3.01" y2="6"></line><line x1="3" y1="12" x2="3.01" y2="12"></line><line x1="3" y1="18" x2="3.01" y2="18"></line>'),
  sort: svgIcon('<path d="M11 5h10"></path><path d="M11 9h7"></path><path d="M11 13h4"></path><path d="M3 17V5"></path><path d="m6 8-3-3-3 3"></path><path d="m0 14 3 3 3-3"></path>'),
  globe: svgIcon('<circle cx="12" cy="12" r="10"></circle><path d="M2 12h20"></path><path d="M12 2a15 15 0 0 1 0 20"></path><path d="M12 2a15 15 0 0 0 0 20"></path>'),
  code: svgIcon('<polyline points="16 18 22 12 16 6"></polyline><polyline points="8 6 2 12 8 18"></polyline>'),
  check: svgIcon('<path d="M20 6 9 17l-5-5"></path>'),
  copy: svgIcon('<rect x="9" y="9" width="13" height="13" rx="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path>'),
  external: svgIcon('<path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line>'),
  ...
  template: svgIcon('<path d="M3 7h18"></path><path d="M7 3v18"></path><rect x="3" y="3" width="18" height="18" rx="2"></rect>'),
  spark: svgIcon('<path d="m12 3 1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8L12 3Z"></path>'),
  info: svgIcon('<circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path>'),
  search: svgIcon('<circle cx="11" cy="11" r="7"></circle><path d="m21 21-4.35-4.35"></path>'),
  lock: svgIcon('<rect x="3" y="11" width="18" height="10" rx="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path>'),
  home: svgIcon('<path d="M3 10.5 12 3l9 7.5"></path><path d="M5 10v10h14V10"></path>'),
  cloud: svgIcon('<path d="M17.5 19a4.5 4.5 0 1 0-.7-8.94A6 6 0 1 0 6 18h11.5Z"></path>'),
  ...
  wallet: svgIcon('<path d="M20 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2Z"></path><path d="M16 13h.01"></path><path d="M6 7V5a2 2 0 0 1 2-2h10"></path>'),
  send: svgIcon('<path d="m22 2-7 20-4-9-9-4Z"></path><path d="M22 2 11 13"></path>'),
  play: svgIcon('<polygon points="5 3 19 12 5 21 5 3"></polygon>'),
  film: svgIcon('<rect x="2" y="3" width="20" height="18" rx="2"></rect><path d="M7 3v18"></path><path d="M17 3v18"></path><path d="M2 8h20"></path><path d="M2 16h20"></path>'),
  gamepad: svgIcon('<path d="M6 12h4"></path><path d="M8 10v4"></path><path d="M15 13h.01"></path><path d="M18 11h.01"></path><path d="M6.8 20h10.4a3 3 0 0 0 2.88-3.84l-1.3-4.55A5 5 0 0 0 13.97 8H10.03a5 5 0 0 0-4.81 3.61l-1.3 4.55A3 3 0 0 0 6.8 20Z"></path>'),
  refresh: svgIcon('<path d="M21 12a9 9 0 1 1-2.64-6.36"></path><polyline points="21 3 21 9 15 9"></polyline>'),
  save: svgIcon('<path d="M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2Z"></path><polyline points="17 21 17 13 7 13 7 21"></polyline><polyline points="7 3 7 8 15 8"></polyline>'),
  tag: svgIcon('<path d="M20.59 13.41 11 3H4v7l9.59 9.59a2 2 0 0 0 2.82 0l4.18-4.18a2 2 0 0 0 0-2.82Z"></path><line x1="7" y1="7" x2="7.01" y2="7"></line>'),
};
...
const DEFAULT_RENDER = {
  ...
  source_prefix_format: "[{source}] {name}",
...
function bindEvents() {
  ...
  document.getElementById("open-batch-import-btn").addEventListener("click", openBatchImportDialog);
  document.getElementById("apply-batch-import-btn").addEventListener("click", applyBatchImport);
  document.getElementById("add-inline-btn").addEventListener("click", () => {
    state.inlineEntries.push(createInlineEntry());
    renderInlineManager();
  });
  document.getElementById("source-mode-rules").addEventListener("click", () => switchSourceMode("rules"));
  document.getElementById("source-mode-template").addEventListener("click", () => switchSourceMode("template"));
  document.getElementById("template-select").addEventListener("change", (event) => selectTemplate(event.target.value));
  document.getElementById("rule-preset-control").addEventListener("click", (event) => {
    const button = event.target.closest("[data-rule-mode]");
    if (!button) return;
    applyRulePreset(button.dataset.ruleMode);
  });
  document.getElementById("toggle-rule-chips-btn").addEventListener("click", toggleRuleChipExpansion);
  document.getElementById("rule-subtab-builtin").addEventListener("click", () => switchRuleSubtab("builtin"));
  document.getElementById("rule-subtab-custom").addEventListener("click", () => switchRuleSubtab("custom"));
  document.getElementById("save-custom-rule-btn").addEventListener("click", saveCustomRuleFromDialog);
  document.getElementById("reset-custom-rule-form-btn").addEventListener("click", resetCustomRuleForm);
  document.getElementById("custom-rule-key").addEventListener("input", renderCustomRulePreview);
  document.getElementById("custom-rule-label").addEventListener("input", renderCustomRulePreview);
  document.getElementById("custom-rule-emoji").addEventListener("input", renderCustomRulePreview);
  document.getElementById("custom-rule-target-mode").addEventListener("change", () => {
    syncCustomRuleFormVisibility();
    renderCustomRulePreview();
  });
  document.getElementById("custom-rule-target-group").addEventListener("input", renderCustomRulePreview);
  document.getElementById("custom-rule-source-type").addEventListener("change", () => {
    syncCustomRuleFormVisibility();
    renderCustomRulePreview();
  });
  document.getElementById("custom-rule-behavior").addEventListener("change", () => {
    syncCustomRuleFormVisibility();
    renderCustomRulePreview();
  });
  document.getElementById("custom-rule-format").addEventListener("change", () => {
    syncCustomRuleFormVisibility();
    renderCustomRulePreview();
  });
  document.getElementById("custom-rule-url").addEventListener("input", renderCustomRulePreview);
  document.getElementById("custom-rule-path").addEventListener("input", renderCustomRulePreview);
  document.getElementById("custom-rule-interval").addEventListener("input", renderCustomRulePreview);
  document.getElementById("custom-rule-insert-position").addEventListener("change", renderCustomRulePreview);
  document.getElementById("custom-rule-enabled").addEventListener("change", renderCustomRulePreview);
  document.getElementById("custom-rule-no-resolve").addEventListener("change", renderCustomRulePreview);
  document.getElementById("custom-rule-payload").addEventListener("input", renderCustomRulePreview);

  document.getElementById("open-node-editor-btn").addEventListener("click", () => switchWorkspace("nodes"));
  document.getElementById("refresh-nodes-btn").addEventListener("click", loadNodes);
  document.getElementById("node-type-filter").addEventListener("change", handleNodeFilterChange);
  document.getElementById("node-region-filter").addEventListener("change", handleNodeFilterChange);
  document.getElementById("node-status-filter").addEventListener("change", handleNodeFilterChange);
  document.getElementById("node-source-filter").addEventListener("change", handleNodeFilterChange);
  document.getElementById("node-page-size").addEventListener("change", handleNodePageSizeChange);
  document.getElementById("node-prev-page-btn").addEventListener("click", () => changeNodePage(-1));
  document.getElementById("node-next-page-btn").addEventListener("click", () => changeNodePage(1));

  document.getElementById("refresh-yaml-btn").addEventListener("click", loadYamlPreview);
  document.getElementById("download-yaml-btn").addEventListener("click", downloadYAML);
  ...
  document.querySelectorAll("[data-toggle-secret]").forEach((button) => {
    button.addEventListener("click", () => toggleSecretField(button.dataset.toggleSecret, button));
  });
...
function switchWorkspace(workspace) {
  ...
  ["config", "nodes", "yaml", "diagnostics"].forEach((name) => {
    document.getElementById(`workspace-${name}`).classList.toggle("hidden", name !== workspace);
  });
...
function fillFormFromConfig(config) {
  ...
  state.activeSourceMode = render.source_mode || render.template_rule_mode || "rules";
  state.ruleMode = render.rule_mode || "full";
  state.enabledRules = new Set(Array.isArray(render.enabled_rules) && render.enabled_rules.length ? render.enabled_rules : RULE_PRESETS.full);
  state.customRules = Array.isArray(render.custom_rules) ? render.custom_rules : [];
...
function renderRulePresetControl() {
  document.querySelectorAll("#rule-preset-control [data-rule-mode]").forEach((button) => {
    button.classList.toggle("active", button.dataset.ruleMode === state.ruleMode);
  });
}
...
function renderRuleChips() {
  ...
  primary.classList.toggle("disabled-panel", state.activeSourceMode !== "rules");
  extra.classList.toggle("disabled-panel", state.activeSourceMode !== "rules");
  ...
  extraWrap.classList.toggle("hidden", !extraRules.length || !state.ruleChipsExpanded);
  toggleButton.classList.toggle("hidden", !extraRules.length);
  setButtonIconText(toggleButton, state.ruleChipsExpanded ? "收起" : "展开全部");
}
...
function renderRuleSubtab() {
  ...
  document.getElementById("rule-subtab-builtin").classList.toggle("active", isBuiltin);
  document.getElementById("rule-subtab-custom").classList.toggle("active", !isBuiltin);
  document.getElementById("rule-builtin-panel").classList.toggle("hidden", !isBuiltin);
  document.getElementById("rule-custom-panel").classList.toggle("hidden", isBuiltin);
  if (!isBuiltin) {
...
function createRuleChip(rule) {
  ...
  `;
  button.disabled = state.activeSourceMode !== "rules";
  button.addEventListener("click", () => {
    if (state.activeSourceMode !== "rules") return;
    toggleRule(rule.key);
  });
  return button;
}
...
function renderSourceMode() {
  ...
  document.getElementById("source-mode-rules").classList.toggle("active", isRules);
  document.getElementById("source-mode-template").classList.toggle("active", !isRules);
  document.getElementById("rules-mode-panel").classList.toggle("hidden", !isRules);
  document.getElementById("template-mode-panel").classList.toggle("hidden", isRules);
}

function renderTemplateOptions() {
  const select = document.getElementById("template-select");
  select.innerHTML = TEMPLATE_OPTION_GROUPS.map((group) => `
    <optgroup label="${escapeHtml(group.label)}">
      ${group.options
        .map((item) => {
          const selected = state.externalConfig.template_key === item.key ? " selected" : "";
...
function currentTemplateOption() {
  return TEMPLATE_OPTIONS.find((item) => item.key === state.externalConfig.template_key) || TEMPLATE_OPTIONS[0];
}

function selectTemplate(templateKey) {
  const selected = TEMPLATE_OPTIONS.find((item) => item.key === templateKey) || TEMPLATE_OPTIONS[0];
...
function renderTemplateDetail() {
  ...
  const serviceTemplate = ((state.config && state.config.service && state.config.service.template) || DEFAULT_SERVICE.template || "standard").toLowerCase();
  const note =
  ...
  `;
  document.getElementById("custom-template-url-wrap").classList.toggle("hidden", selected.key !== "custom_url");
}
...
function renderCustomRuleList() {
  ...
  container.querySelectorAll("[data-custom-rule-toggle]").forEach((checkbox) => {
...
function fillCustomRuleForm(index) {
  ...
  setValue("custom-rule-insert-position", rule.insert_position || "before_match");
  setChecked("custom-rule-enabled", rule.enabled !== false);
  setChecked("custom-rule-no-resolve", Boolean(rule.no_resolve));
  setValue("custom-rule-payload", Array.isArray(rule.payload) ? rule.payload.join("\n") : "");
  syncCustomRuleFormVisibility();
  renderCustomRulePreview();
}
...
function renderCustomRulePreview() {
  ...
  if (draft.source_type === "http" && !draft.url) missing.push("缺少远程规则 URL");
  if (draft.source_type === "file" && !draft.path) missing.push("缺少本地文件路径");
  if (draft.source_type === "inline" && !draft.payload.length) missing.push("缺少内联规则内容");
  if (draft.format === "mrs" && draft.behavior === "classical") missing.push("mrs 不能搭配 classical");
  ...
  if (draft.target_mode === "new_group" || draft.source_type === "group_only") {
    ...
    lines.push(`  - {name: "${targetGroup}", type: select, proxies: ["🚀 节点选择", "⚡ 自动选择", DIRECT, REJECT]}`);
  }
  if (draft.source_type !== "group_only") {
    lines.push("");
    lines.push("rule-providers:");
    if (draft.source_type === "inline") {
      lines.push(`  ${draft.key}: {type: inline, behavior: ${draft.behavior}, format: ${draft.format}, payload: [${draft.payload.map((item) => `"${item}"`).join(", ")}]}`);
    } else if (draft.source_type === "http") {
      lines.push(`  ${draft.key}: {type: http, behavior: ${draft.behavior}, url: "${draft.url}", path: ${draft.path || "./ruleset/" + draft.key + "." + previewFormatExt(draft.format)}, interval: ${draft.interval || 86400}, format: ${draft.format}}`);
    } else if (draft.source_type === "file") {
      lines.push(`  ${draft.key}: {type: file, behavior: ${draft.behavior}, path: ${draft.path}, format: ${draft.format}}`);
    }
    lines.push("");
    lines.push("rules:");
    lines.push(`  - RULE-SET,${draft.key},${targetGroup}${draft.no_resolve ? ",no-resolve" : ""}`);
  }
...
function saveCustomRuleFromDialog() {
  ...
  const duplicate = [...BUILTIN_RULES, ...state.customRules].some((item, index) => {
    if (indexValue !== "" && index === Number.parseInt(indexValue, 10)) return false;
...
function syncCustomRuleFormVisibility() {
  ...
  document.getElementById("custom-rule-target-group-wrap").classList.toggle("hidden", targetMode !== "existing_group");
  document.getElementById("custom-rule-url-wrap").classList.toggle("hidden", sourceType !== "http");
  document.getElementById("custom-rule-path-wrap").classList.toggle("hidden", sourceType !== "file" && sourceType !== "http");
  document.getElementById("custom-rule-interval-wrap").classList.toggle("hidden", sourceType !== "http");
  document.getElementById("custom-rule-payload-wrap").classList.toggle("hidden", sourceType !== "inline");
}
...
function resolveCustomRulePreviewTarget(rule) {
  ...
  if (rule.target_mode === "existing_group") return rule.target_group || "节点选择";
...
function renderInlineManager() {
  ...
  container.innerHTML = state.inlineEntries
    .map((item, index) => `
      <div class="source-row subscription-item inline-row">
        <div class="source-enable">
          <label class="checkbox-line"><input type="checkbox" data-inline-field="enabled" data-inline-index="${index}" ${item.enabled ? "checked" : ""} /> 启用</label>
        </div>
        <div class="source-main">
          <div class="source-row-top manual-row-top">
            <input class="source-name" type="text" data-inline-field="name" data-inline-index="${index}" placeholder="手动源名称" value="${escapeHtml(item.name)}" />
          </div>
          <textarea data-inline-field="content" data-inline-index="${index}" rows="6" placeholder="粘贴单个节点 URI 或 WireGuard 配置片段">${escapeHtml(item.content)}</textarea>
        </div>
        <div class="source-actions">
          <button class="tiny-button warn-text" type="button" data-inline-action="delete" data-inline-index="${index}">删除</button>
        </div>
      </div>
    `)
    .join("");
  ...
  container.querySelectorAll("[data-inline-field]").forEach((element) => {
    ...
    const eventName = isCheckbox ? "change" : "input";
    element.addEventListener(eventName, () => {
      state.inlineEntries[index][field] = isCheckbox ? element.checked : element.value;
      updateSubscriptionSummary();
    });
  });
  container.querySelectorAll("[data-inline-action='delete']").forEach((button) => {
    button.addEventListener("click", () => {
...
function updateSubscriptionSummary() {
  ...
  const inlineCount = state.inlineEntries.filter((item) => item.content.trim()).length;
  const enabledCount = state.subscriptions.filter((item) => item.enabled && item.url.trim()).length;
  document.getElementById("subscription-summary").textContent = `已配置：${subCount} 个订阅源 · ${inlineCount} 个手动节点 · ${enabledCount} 个启用源`;
}
...
function normalizeImportedSubscriptionNames(items) {
  ...
  return items.map((item, index) => {
    const baseName = (item.name || `source-${index + 1}`).trim() || `source-${index + 1}`;
    seen[baseName] = (seen[baseName] || 0) + 1;
    const name = seen[baseName] === 1 ? baseName : `${baseName} ${seen[baseName]}`;
    return {
      ...item,
      id: item.id || `source-${index + 1}`,
      name,
...
function updateSummary() {
  const enabledOptionCount = OUTPUT_OPTIONS.reduce((count, item) => count + (getChecked(item.id) ? 1 : 0), 0);
...
function ruleModeText(mode) {
  return ({ minimal: "最小化", balanced: "均衡", full: "全面", custom: "自定义" })[mode] || "自定义";
}

function buildConfigFromForm() {
  const base = deepClone(state.config || {
  ...
  base.render = {
    ...
    source_prefix: getChecked("opt-source-prefix"),
    ...
    source_mode: state.activeSourceMode,
    template_rule_mode: state.activeSourceMode,
    external_config: {
      template_key: state.externalConfig.template_key,
      template_label: state.externalConfig.template_label,
      custom_url: state.externalConfig.template_key === "custom_url" ? getValue("custom-template-url").trim() : "",
    },
    rule_mode: state.ruleMode,
    enabled_rules: state.activeSourceMode === "rules" ? Array.from(state.enabledRules) : [],
...
function renderNodeStatsStrip() {
  ...
  document.getElementById("node-stats-strip").innerHTML = items
    .map(([label, value]) => `<span class="stat-pill"><strong>${escapeHtml(String(value))}</strong><span>${escapeHtml(label)}</span></span>`)
    .join("");
}

function syncSourceFilterOptions() {
  const select = document.getElementById("node-source-filter");
  const values = uniqueOrdered([state.nodeFilters.source, ...state.nodeSourceOptions].filter(Boolean));
...
function buildNodeFeatureBadges(node) {
  ...
  if (node.transport_network === "xhttp") badges.push('<span class="mini-badge">XHTTP</span>');
  if (node.has_ipv6) badges.push('<span class="mini-badge">IPv6</span>');
  if (node.warnings?.length) badges.push(`<span class="mini-badge warning">警告 ${node.warnings.length}</span>`);
  return badges;
}
...
function renderNodePagination() {
  ...
  document.getElementById("node-page-info").textContent = `第 ${state.nodePagination.page} / ${totalPages} 页 · 共 ${total} 个节点`;
  document.getElementById("node-prev-page-btn").disabled = state.nodePagination.page <= 1;
  document.getElementById("node-next-page-btn").disabled = state.nodePagination.page >= totalPages;
}
...
async function saveNodeOverride(regenerate) {
  ...
  const response = await fetchJSON(`/api/nodes/${encodeURIComponent(nodeId)}/override`, {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
...
async function resetNodeOverride(nodeId) {
  const response = await fetchJSON(`/api/nodes/${encodeURIComponent(nodeId)}/reset`, {
    method: "POST",
  });
  if (!response?.ok) {
...
async function toggleNodeEnabled(nodeId, enabled) {
  const response = await fetchJSON(enabled ? "/api/nodes/enable" : "/api/nodes/disable", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
function openBulkRenameDialog(scope) {
  ...
  else setValue("bulk-rename-scope", state.selectedNodeIds.size ? "selected" : "current_filtered");
  previewBulkRename();
...
function previewBulkRename() {
  ...
  const lines = targets.slice(0, 10).map((node) => `${node.name} -> ${previewRenamedName(node)}`);
  preview.textContent = lines.join("\n");
}
...
function previewRenamedName(node) {
  ...
  if (mode === "protocol_prefix") return `[${String(node.type).toUpperCase()}] ${node.name}`.trim();
  if (mode === "region_emoji") return `${regionEmoji(node.region)} ${node.name}`.trim();
  if (mode === "remove_info_text") {
    return node.name.replace(/(剩余流量[:：]?\s*[^ ]+|到期时间[:：]?\s*[^ ]+|官网[:：]?\s*[^ ]+|套餐[:：]?\s*[^ ]+)/gi, "").trim();
  }
...
async function applyBulkRename() {
  const payload = {
    ...
    ids: getValue("bulk-rename-scope") === "selected" ? Array.from(state.selectedNodeIds) : [],
...
function switchAddNodeMode(mode) {
  ...
  document.getElementById("add-node-tab-uri").classList.toggle("active", mode === "uri");
  document.getElementById("add-node-tab-manual").classList.toggle("active", mode === "manual");
  document.getElementById("add-node-uri-panel").classList.toggle("hidden", mode !== "uri");
  document.getElementById("add-node-manual-panel").classList.toggle("hidden", mode !== "manual");
}
...
function renderYamlViewer() {
  ...
  const visibleText = limitLines(state.yamlPreview || "", YAML_PREVIEW_LINE_LIMIT);
  ...
  code.innerHTML = html;
  document.getElementById("yaml-search-meta").textContent = query
    ? `当前预览匹配 ${matchCount} 处 · 预览内容为前 ${YAML_PREVIEW_LINE_LIMIT} 行`
    : `预览内容为前 ${YAML_PREVIEW_LINE_LIMIT} 行，完整内容请下载使用。`;
}
...
async function loadLogs() {
  ...
  state.logsText = response?.ok ? (response.lines || []).join("\n") : JSON.stringify(response || {}, null, 2);
...
function renderDiagnostics() {
  ...
  document.getElementById("diagnostic-warning-list").innerHTML = diagnosticItems.length
    ? diagnosticItems.map((item) => `<div class="diagnostic-item"><strong>${escapeHtml(item.title)}</strong><div class="meta-text">${escapeHtml(item.detail)}</div></div>`).join("")
...
function extractLogDiagnostics(logText) {
  ...
  lines.forEach((line) => {
    ...
    if (lower.includes("duplicate proxy-group name") || lower.includes("duplicate group")) {
      diagnostics.duplicateGroups += 1;
      diagnostics.items.push({ title: "重复代理组", detail: line });
    }
    if (lower.includes("rule provider") && (lower.includes("missing") || lower.includes("not found"))) {
...
function renderYAMLLine(line, query) {
  ...
  if (colonIndex >= 0) {
    ...
    return {
      ...
      count: indentToken.count + keyToken.count + colonToken.count + valueToken.count,
    };
  }
...
function renderInlineYAML(text, query) {
  ...
  while (index < text.length) {
    ...
    if (char === '"' || char === "'") {
      ...
      const token = renderHighlightedToken(text.slice(index, end), "yaml-string", query);
      html += token.html;
      count += token.count;
      index = end;
      continue;
    ...
    if (char === "#") {
      const token = renderHighlightedToken(text.slice(index), "yaml-comment", query);
      html += token.html;
      count += token.count;
      break;
    }
